...
class StatusController(QObject):
    ...
    def _initialize_pipeline(self) -> None:
        ...
        try:
            ...
            self.status_error.emit(f"Failed to initialize pipeline: {str(e)}")
    ...
    def update_system_info(self) -> None:
        ...
        try:
            ...
            self.status_error.emit(f"Failed to update system info: {str(e)}")
    ...
    def update_performance_metrics(self) -> None:
        ...
        try:
            ...
            self.status_error.emit(f"Failed to update performance metrics: {str(e)}")
    ...
    def start_auto_refresh(self, interval_ms: int = 5000) -> None:
        ...
        self.status_message.emit(f"Auto-refresh started ({interval_ms/1000:.1f}s interval)")
    ...
    def _on_task_finished(self, task_id: str, result: Any) -> None:
        ...
        if task_id == "health_check":
            ...
            self.status_message.emit(f"Health check completed: {healthy_count}/{total_count} components healthy")
        elif task_id == "collection_info":
