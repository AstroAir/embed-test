...
from PySide6.QtWidgets import QSplitter, QHeaderView, QWidget, QHBoxLayout, QTableWidgetItem
...
class DocumentWidget(BaseWidget):
    ...
    def _setup_ui(self) -> None:
        ...
        docs_title.setStyleSheet("font-weight: bold; font-size: 14px; margin-bottom: 10px;")
        ...
        details_title.setStyleSheet("font-weight: bold; font-size: 14px; margin-bottom: 10px;")
    ...
    def _on_statistics_updated(self, stats: Dict[str, Any]) -> None:
        ...
        stats_text += f"Average Chunk Size: {stats.get('average_chunk_size', 0):.0f} characters"
