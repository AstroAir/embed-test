...
class LogWidget(BaseWidget):
    ...
    def refresh_logs(self) -> None:
        ...
        log_locations = [
            Path("logs/pdf_vector_system.log"),
            Path("pdf_vector_system.log"),
            Path.home() / ".pdf_vector_system" / "logs" / "app.log",
            Path("app.log"),
        ]
        ...
        if not logs:
            logs = [
                ...
                "2024-01-15 10:30:18 | INFO | pdf_vector_system.vector_db | Vector database client initialized",
                "2024-01-15 10:30:19 | INFO | pdf_vector_system.gui | Log widget initialized - no log file found",
            ]
