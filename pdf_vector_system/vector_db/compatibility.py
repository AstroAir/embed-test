...
from pdf_vector_system.config.settings import ChromaDBConfig as OldChromaDBConfig
from pdf_vector_system.vector_db.chroma_client import ChromaDBClient
from pdf_vector_system.vector_db.config import ChromaDBConfig as NewChromaDBConfig
...
### New (recommended):
```python
from pdf_vector_system.vector_db import VectorDBFactory, ChromaDBConfig
...
# New
from pdf_vector_system.vector_db import SearchQuery
