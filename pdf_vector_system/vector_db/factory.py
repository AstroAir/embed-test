...
from pdf_vector_system.vector_db.models import VectorDBError
...
class VectorDBFactory:
    ...
    _REGISTRY: dict[VectorDBType, dict[str, Any]] = {
        VectorDBType.CHROMADB: {
            "client_class": "pdf_vector_system.vector_db.chroma_client.ChromaDBClient",
        ...
        VectorDBType.PINECONE: {
            "client_class": "pdf_vector_system.vector_db.pinecone_client.PineconeClient",
        ...
        VectorDBType.WEAVIATE: {
            "client_class": "pdf_vector_system.vector_db.weaviate_client.WeaviateClient",
            "config_class": WeaviateConfig,
            "required_packages": ["weaviate"],
            "description": "Weaviate - Open-source vector database with GraphQL API",
        },
        VectorDBType.QDRANT: {
            "client_class": "pdf_vector_system.vector_db.qdrant_client.QdrantClient",
        ...
        VectorDBType.MILVUS: {
            "client_class": "pdf_vector_system.vector_db.milvus_client.MilvusClient",
