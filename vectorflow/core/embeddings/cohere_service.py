...
from vectorflow.core.embeddings.provider_configs import ProviderRetryConfigs
from vectorflow.core.embeddings.retry import FailureType, RetryableError, RetryHandler
...
class CohereEmbeddingService(EmbeddingService):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        from vectorflow.core.config.settings import EmbeddingConfig
