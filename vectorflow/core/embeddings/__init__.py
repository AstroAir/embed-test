...
_COHERE_AVAILABLE = (
    importlib.util.find_spec("vectorflow.core.embeddings.cohere_service") is not None
)
_HUGGINGFACE_AVAILABLE = (
    importlib.util.find_spec("vectorflow.core.embeddings.huggingface_service")
    is not None
)
_GOOGLE_USE_AVAILABLE = (
    importlib.util.find_spec("vectorflow.core.embeddings.google_use_service")
    is not None
)
_AZURE_OPENAI_AVAILABLE = (
    importlib.util.find_spec("vectorflow.core.embeddings.azure_openai_service")
    is not None
)
_GOOGLE_GEMINI_AVAILABLE = (
    importlib.util.find_spec("vectorflow.core.embeddings.gemini_service") is not None
)
...
if _COHERE_AVAILABLE:
    from vectorflow.core.embeddings.cohere_service import (  # noqa: F401
...
if _HUGGINGFACE_AVAILABLE:
    from vectorflow.core.embeddings.huggingface_service import (  # noqa: F401
...
if _GOOGLE_USE_AVAILABLE:
    from vectorflow.core.embeddings.google_use_service import (  # noqa: F401
        GoogleUSEService,
    )
...
if _AZURE_OPENAI_AVAILABLE:
    from vectorflow.core.embeddings.azure_openai_service import (  # noqa: F401
...
if _GOOGLE_GEMINI_AVAILABLE:
    from vectorflow.core.embeddings.gemini_service import (  # noqa: F401
