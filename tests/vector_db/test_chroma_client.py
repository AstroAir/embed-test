...
class TestChromaDBClient:
    ...
    def test_initialization(self, temp_dir):
        ...
        with patch('pdf_vector_system.vector_db.chromadb_client.chromadb.PersistentClient') as mock_client_class:
            mock_client = Mock()
            ...
            mock_client_class.assert_called_once_with(path=str(config.persist_directory))
    ...
    def test_initialization_creates_directory(self, temp_dir):
        ...
        with patch('pdf_vector_system.vector_db.chromadb_client.chromadb.PersistentClient'):
    ...
    def test_delete_documents_by_filter(self):
        ...
        with patch('pdf_vector_system.vector_db.chromadb_client.chromadb.PersistentClient') as mock_client_class:
            ...
            assert result is True
            mock_collection.delete.assert_called_once_with(where={"document_id": "doc_1"})
