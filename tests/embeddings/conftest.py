...
from pdf_vector_system.embeddings.base import EmbeddingService, EmbeddingResult, EmbeddingBatch
from pdf_vector_system.config.settings import EmbeddingConfig, EmbeddingModelType
from tests.mocks.embedding_mocks import (
    MockEmbeddingService, MockSentenceTransformersService, MockOpenAIService
)
...
def mock_retry_config():
    ...
    from pdf_vector_system.embeddings.retry import RetryConfig
    return RetryConfig(
        max_retries=3,
        initial_delay=0.1,
        max_delay=1.0,
