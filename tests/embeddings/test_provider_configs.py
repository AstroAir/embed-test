...
from pdf_vector_system.embeddings.provider_configs import (
    ProviderRetryConfigs, ProviderBatchConfigs, ProviderHealthConfigs
)
from pdf_vector_system.embeddings.retry import RetryConfig, RetryStrategy, FailureType
...
class TestProviderRetryConfigs:
    ...
    def test_get_config_for_provider(self):
        ...
        providers = [
            "openai", "cohere", "azure_openai", "google_gemini",
            "huggingface", "google_use", "sentence_transformers"
        ]
...
class TestProviderHealthConfigs:
    ...
    def test_health_config_expected_dimensions(self):
        ...
        if "expected_dimension" in config and config["expected_dimension"]:
    ...
    def test_health_config_consistency(self):
        ...
        for provider in providers:
            ...
            required_fields = ["test_text", "timeout", "check_interval", "failure_threshold"]
