...
from pdf_vector_system.embeddings.gemini_service import GeminiEmbeddingService
from pdf_vector_system.embeddings.base import EmbeddingServiceError, ModelNotFoundError
...
class TestGeminiEmbeddingService:
    ...
    def test_init_vertex_ai_missing_project_id(self):
        ...
        with pytest.raises(ValueError, match="project_id is required when using Vertex AI"):
    ...
    def test_extract_embeddings_no_data(self):
        ...
        with pytest.raises(EmbeddingServiceError, match="No embeddings found in API response"):
