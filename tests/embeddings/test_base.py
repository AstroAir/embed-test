...
from pdf_vector_system.embeddings.base import (
    EmbeddingService, EmbeddingResult, EmbeddingBatch, EmbeddingServiceError
)
...
class TestEmbeddingServiceError:
    ...
    def test_exception_with_cause(self):
        ...
        error = EmbeddingServiceError("Wrapper error") from original_error
...
class TestEmbeddingErrorScenarios:
    ...
    def test_embedding_result_mismatched_lengths(self):
        ...
        with pytest.raises(ValueError, match="embeddings and texts must have the same length"):
            EmbeddingResult(
    ...
    def test_embedding_service_error_inheritance(self):
        ...
        error_with_context = EmbeddingServiceError("Error", {"context": "additional info"})
