...
class MockCollection:
    ...
    def __init__(self, name: str = "test_collection", metadata: Optional[Dict[str, Any]] = None):
        self.name = name
    ...
    def get(
        ...
        if where:
            ...
            if "document_id" in where:
                filtered_ids = [
                    id_ for id_ in filtered_ids 
                    if self._metadatas.get(id_, {}).get("document_id") == where["document_id"]
                ]
    ...
    def delete(
        ...
        if ids:
            ...
            if "document_id" in where:
                ids_to_delete = [
                    id_ for id_, meta in self._metadatas.items()
