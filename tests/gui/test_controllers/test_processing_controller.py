...
class TestProcessingController:
    ...
    def test_controller_initialization(self, mock_config, mock_pipeline):
        ...
        with patch('pdf_vector_system.gui.controllers.processing_controller.PDFVectorPipeline') as mock_pipeline_class:
    ...
    def test_process_files_success(self, mock_pipeline_class, mock_config, mock_pipeline):
    ...
    @patch('pdf_vector_system.gui.controllers.processing_controller.PDFVectorPipeline')
    def test_process_files_with_errors(self, mock_pipeline_class, mock_config, mock_pipeline):
