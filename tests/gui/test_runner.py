...
class GUITestRunner:
    ...
    def run_widget_tests(self, widget_name: Optional[str] = None) -> int:
        ...
        return subprocess.call([
            'pytest', str(test_path), '-v', '-m', 'widget'
        ])
    ...
    def run_controller_tests(self, controller_name: Optional[str] = None) -> int:
        ...
        """
        if controller_name:
            test_path = self.test_dir / 'test_controllers' / f'test_{controller_name}_controller.py'
        else:
            test_path = self.test_dir / 'test_controllers'
            
        return subprocess.call([
            'pytest', str(test_path), '-v', '-m', 'controller'
        ])
    ...
    def run_integration_tests(self) -> int:
        ...
        """
        return subprocess.call([
            'pytest', str(self.test_dir / 'test_integration'), '-v', '-m', 'integration'
        ])
    ...
    def run_smoke_tests(self) -> int:
        ...
        """
        return subprocess.call([
            'pytest', str(self.test_dir), '-v', '-m', 'smoke'
        ])
    ...
    def run_tests_by_marker(self, marker: str) -> int:
        ...
        """
        return subprocess.call([
            'pytest', str(self.test_dir), '-v', '-m', marker
        ])
...
def main():
    ...
    parser.add_argument('--controllers', action='store_true', help='Run controller tests')
    ...
    parser.add_argument('--list-markers', action='store_true', help='List available markers')
    parser.add_argument('--coverage', action='store_true', default=True, help='Enable coverage')
