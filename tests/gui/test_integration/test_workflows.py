...
class TestPDFProcessingWorkflow:
    ...
    def test_complete_pdf_processing_workflow(self, qtbot, mock_config, mock_file_dialog, mock_pipeline):
        ...
        with patch.object(window.processing_widget.controller, 'pipeline', mock_pipeline):
            ...
            mock_file_dialog.getOpenFileNames.return_value = (test_files, 'PDF Files (*.pdf)')
            
            qtbot.mouseClick(window.processing_widget.select_files_btn, Qt.MouseButton.LeftButton)
            ...
            qtbot.mouseClick(window.processing_widget.process_btn, Qt.MouseButton.LeftButton)
    ...
    def test_pdf_processing_with_errors(self, qtbot, mock_config, mock_file_dialog, mock_pipeline):
...
class TestDocumentManagementWorkflow:
    ...
    def test_document_list_and_details_workflow(self, qtbot, mock_config, mock_pipeline):
    ...
    def test_document_deletion_workflow(self, qtbot, mock_config, mock_pipeline, mock_message_box):
...
class TestConfigurationWorkflow:
    ...
    def test_configuration_edit_and_save_workflow(self, qtbot, mock_config, mock_file_dialog):
        ...
        # Save configuration
        mock_file_dialog.getSaveFileName.return_value = ('/test/config.json', 'JSON Files (*.json)')
...
class TestStatusMonitoringWorkflow:
    ...
    def test_health_check_workflow(self, qtbot, mock_config, mock_pipeline):
        ...
        with patch.object(window.status_widget.controller, 'pipeline', mock_pipeline):
            ...
            qtbot.mouseClick(window.status_widget.health_check_btn, Qt.MouseButton.LeftButton)
...
class TestCrossTabWorkflow:
    ...
    def test_process_then_search_workflow(self, qtbot, mock_config, mock_file_dialog, mock_pipeline):
    ...
    def test_configuration_update_propagation(self, qtbot, mock_config):
        ...
        for widget in [window.processing_widget, window.search_widget, 
                      window.document_widget, window.status_widget]:
