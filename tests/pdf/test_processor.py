...
from pdf_vector_system.pdf.processor import PDFProcessor, PDFProcessingError
from pdf_vector_system.config.settings import PDFConfig
from tests.mocks.pdf_mocks import MockPDFDocument, create_mock_pdf_document
...
class TestPDFProcessor:
    ...
    def test_extract_text_file_too_large(self, temp_dir):
        ...
        with patch.object(Path, 'stat') as mock_stat:
            ...
            with pytest.raises(PDFProcessingError, match="File size .* exceeds maximum"):
